...
<head>
  ...
  <title>Manage All Entries</title>
	<br>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <h2 class="text-center">Manage All Entries</h2>
    <div class="row">
      ...
      <div class="container">
        ...
        <div class="btnAdd">
          ...
          <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal" class="btn btn-success btn-sm">Add Entry</a>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $('#example').DataTable({
        ...
        'ajax': {
          ...
          'url': 'administrator_fetch_data.php',
    ...
    $(document).on('submit', '#addUser', function(e) {
      ...
      if (first_name != '' && last_name != '' && username != '' && email != '' && account_type != '' ) {
        ...
        $.ajax({
          ...
          url: "administrator_add_user.php",
    ...
    $(document).on('submit', '#updateUser', function(e) {
      ...
      var category = $('#firstNameField').val();

      var scientific_name = $('#lastNameField').val();

      var common_name = $('#firstNameField').val();

      var count = $('#lastNameField').val();

      var weather = $('#nameField').val();

      var temperature = $('#emailField').val();

      var latitude = $('#accountTypeField').val();

      var longitude = $('#accountTypeField').val();
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (status == 'true') {
              ...
              row.row("[id='" + trid + "']").data([id, user, email, category, scientific_name, common_name, count, weather, temperature, latitude, longitude, date, time, confidence_rating, image, button]);
    ...
    $('#example').on('click', '.editbtn ', function(event) {
      ...
      $.ajax({
        ...
        url: "administrator_get_single_data.php",
    ...
    $(document).on('click', '.deleteBtn', function(event) {
      ...
      if (confirm("Are you sure want to delete this User ? ")) {
        ...
        $.ajax({
          ...
          url: "administrator_delete_user.php",
