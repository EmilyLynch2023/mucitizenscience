...
<br><br><br><br><br><br><br><br><br><br> 
    ...
    <div class="wrapper">
        ...
        <label class="field-label">Reset Password</h2>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" name="new_password" class="text-field formbox w-input form-control <?php echo (!empty($new_password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $new_password; ?>">
            ...
            <div class="form-group">
                ...
                <input type="password" name="confirm_password" class="text-field formbox w-input form-control <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>">
