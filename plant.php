...
date_default_timezone_set(timezoneId: 'America/Indiana/Indianapolis');
...
<head>
  <meta charset="utf-8">
  <title>Plant Observation</title>
  <meta content="Plant Observation" property="og:title">
  <meta content="Plant Observation" property="twitter:title">
...
<body>
  ...
  <div style="margin-top: 0px; margin-bottom: 0px; padding-top: 142px; padding-bottom: 79px; background-image: url('/images/MUCS_PlantsBackground.png'); background-position: 50% 50%; background-size: cover; 0px" class="wf-section">
    <div class="w-container">
      <h1 class="heading">Plant Observation</h1>
      <div class="text-block-4">MUCS OBSERVATION</div>
    </div>
  </div>
...
<label for="weather" class="field-label">WEATHER</label><select id="weather" name="weather" data-name="weather" class="select-field w-select">
       ...
       </select><label for="confidence" class="field-label">LEVEL OF CONFIDENCE</label><select id="confidence" name="confidence" data-name="confidence" required="" class="select-field w-select">
